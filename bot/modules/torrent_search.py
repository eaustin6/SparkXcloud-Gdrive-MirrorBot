...
torrents_dict = {
    '1337x': {'source': "https://torrents-api.ryukme.repl.co/api/1337x/", 'result_str': RESULT_STR_1337},
    'piratebay': {'source': "https://torrents-api.ryukme.repl.co/api/piratebay/", 'result_str': RESULT_STR_PIRATEBAY},
    'tgx': {'source': "https://torrents-api.ryukme.repl.co/api/tgx/", 'result_str': RESULT_STR_TGX},
    'yts': {'source': "https://torrents-api.ryukme.repl.co/api/yts/", 'result_str': RESULT_STR_YTS},
    'eztv': {'source': "https://torrents-api.ryukme.repl.co/api/eztv/", 'result_str': RESULT_STR_EZTV},
    'torlock': {'source': "https://torrents-api.ryukme.repl.co/api/torlock/", 'result_str': RESULT_STR_TORLOCK},
    'rarbg': {'source': "https://torrents-api.ryukme.repl.co/api/rarbg/", 'result_str': RESULT_STR_RARBG},
    'ts': {'source': "https://torrents-api.ryukme.repl.co/api/all/", 'result_str': RESULT_STR_ALL}
}
